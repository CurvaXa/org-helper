...
const CreateRoleCommand = require('../commands_discord/moderation/create-role-command');
...
*/
/**
 * Class represents command available for the Slack
 */
class SlackCommandManager extends CommandManager {
  /**
...
module.exports = SlackCommandManager;
